...
builder.Services.AddScoped<IUseCase<CreateCartItemUseCaseInput, CreateCartItemUseCaseOutput>, CreateCartItemUseCase>();
...
builder.Services.AddScoped<IUseCase<CreateAddressUserUseCaseInput, CreateAddressUserUseCaseOutput>, CreateAddressUserUseCase>();
...
builder.Services.AddScoped<IRepository<BillDetail>,  Repository<BillDetail>>();
builder.Services.AddScoped<IRepository<Bill>, Repository<Bill>>();
builder.Services.AddScoped<IUseCasePayment<CreateUrlPaymentUseCaseInput, CreateUrlPaymentUseCaseOutput>, CreateUrlPaymentUseCase>();
builder.Services.AddScoped<BillConverter>();
builder.Services.AddScoped<IUseCase<CreateBillUseCaseInput, CreateBillUseCaseOutput>, CreateBillUseCase>();
builder.Services.AddScoped<IUseCaseGetById<long, GetBillByIdUseCaseOutput>, GetBillByIdUseCase>();
builder.Services.AddScoped<IRepository<UserVoucher>, Repository<UserVoucher>>();
...
builder.Services.AddScoped<IUseCase<VnPayReturnUseCaseInput, VnPayReturnUseCaseOutput>, VnPayReturnUseCase>();
...
builder.Services.AddScoped<IUseCaseGetById<long, GetAddressUserByUserIdUseCaseOutput>, GetAddressUserByUserIdUseCase>();
builder.Services.AddScoped<IUseCaseGetById<long, GetCartByUserIdUseCaseOutput>, GetCartByUserIdUseCase>();
...
builder.Services.AddScoped<IUseCaseGetById<long, GetBookReviewByIdUseCaseOutput>, GetBookReviewByIdUseCase>();
...
builder.Services.AddScoped<CartItemConverter>();
...
builder.Services.AddScoped<IUseCase<CreateCartUseCaseInput, CreateCartUseCaseOutput>, CreateCartUseCase>(); 
builder.Services.AddScoped<IUseCaseGetById<long, GetCartByIdUseCaseOutput>, GetCartByIdUseCase>();
