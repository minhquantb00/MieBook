          ...
          <div class="navbar-content">
            <ul class="pc-navbar">
              ...
              <li
                ...
                :class="{ active: this.$route.path === '/layouts' }"
              >
                ...
                <BCollapse id="collapse-27">
                  <ul class="pc-submenu">
                    ...
                    <li class="pc-item">
                      <router-link
                        class="pc-link"
                        @click="changeLayoutType('horizontal')"
                        to="/layout/horizontal"
                        >Horizontal</router-link
                      >
                    </li>
                    <li class="pc-item">
                      <router-link class="pc-link" to="/layout/layout-2"
                        >Layout-2</router-link
                      >
                    </li>
                    <li class="pc-item">
                      <a class="pc-link" @click="changeLayoutType('vertical')" to="#"
                        >Vertical</a
                      >
                    </li>
                  </ul>
              ...
              <li class="pc-item pc-hasmenu">
                <BLink class="pc-link" v-b-toggle.collapse-1>
                  ...
                  <span class="pc-mtext">Ui-kit</span
                  ><span class="pc-arrow">
                    <ChevronDownIcon></ChevronDownIcon>
                  </span>
                </BLink>
                <BCollapse id="collapse-1">
                  <ul class="pc-submenu">
                    ...
                    >
                      <router-link class="pc-link" to="/setting">Settings</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/plans' }"
                    >
                      <router-link class="pc-link" to="/plans">Plans</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/login-modal' }"
                    >
                      <router-link class="pc-link" to="/login-modal"
                        >Login Modal</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/search-page' }"
                    >
                      <router-link class="pc-link" to="/search-page"
                        >Search Page</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/affiliate-dashboard' }"
                    >
                      <router-link class="pc-link" to="/affiliate-dashboard"
                        >Affiliate Dashboard</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/gallery-1' }"
                    >
                      <router-link class="pc-link" to="/gallery-1">Gallery</router-link>
                    </li>
                    <li class="pc-item ms-4" :class="{ active: $route.path === '/team' }">
                      <router-link class="pc-link" to="/team">Team</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/loading' }"
                    >
                      <router-link class="pc-link" to="/loading">Loading</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/contact-search' }"
                    >
                      <router-link class="pc-link" to="/contact-search"
                        >Contact Search</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                    ...
                    >
                      <router-link class="pc-link" to="/contact-us"
              ...
              <li class="pc-item pc-hasmenu">
                <BLink class="pc-link" v-b-toggle.collapse-2
                  ><span class="pc-micon">
                    <i class="ph-duotone ph-flower-lotus"></i></span
                  ><span class="pc-mtext">Icons</span
                  ><span class="pc-arrow">
                    <ChevronDownIcon></ChevronDownIcon> </span
                ></BLink>
                <BCollapse id="collapse-2">
                  <ul class="pc-submenu">
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/feather' }"
                    >
                      <router-link class="pc-link" to="/feather">Feather</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/tabler' }"
                    >
                      <router-link class="pc-link" to="/tabler">Tabler</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/phosphor ' }"
                    >
                      <router-link class="pc-link" to="/phosphor">Phosphor</router-link>
                    </li>
                  </ul>
                </BCollapse>
              </li>
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <BCollapse id="collapse-3">
                  <ul class="pc-submenu">
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/form-element' }"
                    >
                      <router-link class="pc-link" to="/form-element"
                        >Form Basic</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/floating' }"
                    >
                      <router-link class="pc-link" to="/floating"
                        >Form Floating</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/form-option' }"
                    >
                      <router-link class="pc-link" to="/form-option"
                        >Form Options</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/input-group' }"
                    >
                      <router-link class="pc-link" to="/input-group"
                        >Input Groups</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/checkbox' }"
                    >
                      <router-link class="pc-link" to="/checkbox">Checkbox</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/radio' }"
                    >
                      <router-link class="pc-link" to="/radio">Radio</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/switch' }"
                    >
                      <router-link class="pc-link" to="/switch">Switch</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/mega-option' }"
                    >
                      <router-link class="pc-link" to="/mega-option"
                        >Mega option</router-link
                      >
                    </li>
                  </ul>
                </BCollapse>
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <BCollapse id="collapse-7">
                  <ul class="pc-submenu">
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/layouts' }"
                    >
                      <router-link class="pc-link" to="/layouts">Layouts</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/multicolumn' }"
                    >
                      <router-link class="pc-link" to="/multicolumn"
                        >Multicolumn</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/actionbars' }"
                    >
                      <router-link class="pc-link" to="/actionbars"
                        >Actionbars</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/sticky-action' }"
                    >
                      <router-link class="pc-link" to="/sticky-action"
                        >Sticky Action bars</router-link
                      >
                    </li>
                  </ul>
                </BCollapse>
              ...
              <li class="pc-item pc-hasmenu" v-b-toggle.collapse-8>
                ...
                <BCollapse id="collapse-8">
                  <ul class="pc-submenu">
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/dropzone' }"
                    >
                      <router-link class="pc-link" to="/dropzone">Dropzone</router-link>
                    </li>
              ...
              <li
                class="pc-item"
                :class="{ active: this.$route.path === '/image-croper' }"
              >
                <router-link to="/image-croper" class="pc-link">
                  <span class="pc-micon">
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <BCollapse id="collapse-9">
                  <ul class="pc-submenu">
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/basic-table' }"
                    >
                      <router-link class="pc-link" to="/basic-table"
                        >Basic table</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/sizing-table' }"
                    >
                      <router-link class="pc-link" to="/sizing-table"
                        >Sizing table</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/border-table' }"
                    >
                      <router-link class="pc-link" to="/border-table"
                        >Border table</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/styling-table' }"
                    >
                      <router-link class="pc-link" to="/styling-table"
                        >Styling table</router-link
                      >
                    </li>
                  </ul>
                </BCollapse>
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <BCollapse id="collapse-10">
                  <ul class="pc-submenu">
                    ...
                    >
                      <router-link class="pc-link" to="/basic"
                        >Basic initialization</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/dynamic import' }"
                    >
                      <router-link class="pc-link" to="/dynamic import"
                        >Dynamic Import</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/column cells' }"
                    >
                      <router-link class="pc-link" to="/column cells"
                        >Render Column Cells</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/datetime sorting' }"
                    >
                      <router-link class="pc-link" to="/datetime sorting"
                        >Datetime Sorting</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/method' }"
                    >
                      <router-link class="pc-link" to="/method">Methods</router-link>
                    </li>
                    <li class="pc-item ms-4" :class="{ active: $route.path === '/row' }">
                      <router-link class="pc-link" to="/row">Add Rows</router-link>
                    </li>
                    <li class="pc-item ms-4" :class="{ active: $route.path === '/api' }">
                      <router-link class="pc-link" to="/api">Fetch API</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/filter' }"
                    >
                      <router-link class="pc-link" to="/filter">Filters</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/export' }"
                    >
                      <router-link class="pc-link" to="/export">Export</router-link>
                    </li>
                  </ul>
                </BCollapse>
              </li>
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <BCollapse id="collapse-13">
                  <ul class="pc-submenu">
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/apexchart' }"
                    >
                      <router-link class="pc-link" to="/apexchart"
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <BCollapse id="collapse-14">
                  <ul class="pc-submenu">
                    <li class="pc-item ms-4" :class="{ active: $route.path === '/maps' }">
                      <router-link class="pc-link" to="/maps">Google Map</router-link>
                    </li>
                  </ul>
                </BCollapse>
              </li>
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <BCollapse id="collapse-15">
                  <ul class="pc-submenu">
                    ...
                    >
                      <router-link class="pc-link" to="/product">Product</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/product-details' }"
                    >
                      <router-link class="pc-link" to="/product-details"
                    ...
                    >
                      <router-link class="pc-link" to="/product-list"
                        >Product List</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/add-product' }"
                    >
                      <router-link class="pc-link" to="/add-product"
                    ...
                    >
                      <router-link class="pc-link" to="/checkout">Checkout</router-link>
                    </li>
                  </ul>
                </BCollapse>
              </li>
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <BCollapse id="collapse-16">
                  <ul class="pc-submenu">
                    ...
                    >
                      <router-link class="pc-link" to="/account-profile"
                        >Account Profile</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/social-media' }"
                    >
                      <router-link class="pc-link" to="/social-media"
                        >Social media</router-link
                      >
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/user-card' }"
                    >
                      <router-link class="pc-link" to="/user-card">User Card</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/user-list' }"
                    >
                      <router-link class="pc-link" to="/user-list">User List</router-link>
                    </li>
                  </ul>
                </BCollapse>
              </li>
              <li class="pc-item pc-hasmenu">
                ...
                <BCollapse id="collapse-17">
                  <ul class="pc-submenu">
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/invoice-list' }"
                    >
                      <router-link class="pc-link" to="/invoice-list"
                    ...
                    >
                      <router-link class="pc-link" to="/create">Create</router-link>
                    </li>
                    <li
                      class="pc-item ms-4"
                      :class="{ active: $route.path === '/preview' }"
                    >
                      <router-link class="pc-link" to="/preview">Preview</router-link>
                    </li>
                  </ul>
                </BCollapse>
              </li>
                ...
                <ul class="pc-submenu">
                  <li class="pc-item pc-hasmenu ms-4" v-b-toggle.collapse-19>
                    ...
                    <BCollapse id="collapse-19">
                      <ul class="pc-submenu">
                        <li class="pc-item ms-4">
                          <router-link class="pc-link" target="_blank" to="/login-v1"
                            >Login</router-link
                          >
                        </li>
                        <li class="pc-item ms-4">
                          <router-link class="pc-link" target="_blank" to="/register-v1"
                        ...
                        <li class="pc-item ms-4">
                          <router-link
                            class="pc-link"
                            target="_blank"
                            to="/code-verification-v1"
                            >code verification</router-link
                          >
                        </li>
                      </ul>
                    </BCollapse>
                  ...
                  <li class="pc-item pc-hasmenu ms-4">
                    <BLink class="pc-link" v-b-toggle.collapse-21
                    ...
                    <BCollapse id="collapse-21">
                      <ul class="pc-submenu">
                        <li class="pc-item ms-4">
                          <router-link class="pc-link" target="_blank" to="/login-v2"
                            >Login</router-link
                          >
                        </li>
                        <li class="pc-item ms-4">
                          <router-link class="pc-link" target="_blank" to="/register-v2"
                            >Register</router-link
                          >
                        </li>
                        <li class="pc-item ms-4">
              ...
              <li class="pc-item pc-hasmenu" v-b-toggle.collapse-22>
                ...
                <BCollapse id="collapse-22">
                  <ul class="pc-submenu">
                    <li class="pc-item ms-4">
                      <router-link class="pc-link" target="_blank" to="/error-404"
                        >Error 404</router-link
                      >
                    </li>
                    <li class="pc-item ms-4">
                      <router-link class="pc-link" target="_blank" to="/connection-lost"
                        >Connection lost</router-link
                      >
                    </li>
                    <li class="pc-item ms-4">
                      <router-link
                    ...
                    <li class="pc-item ms-4">
                      <router-link class="pc-link" target="_blank" to="/comming-soon"
              ...
              <li class="pc-item" :class="{ active: this.$route.path === '/' }">
                <router-link to="/" class="pc-link" target="_blank"
                  ><span class="pc-micon"> <i class="ph-duotone ph-rocket"></i> </span
                  ><span class="pc-mtext">Landing</span></router-link
                >
              </li>
              <li class="pc-item pc-caption">
                <label>Other</label>
              ...
              <li
                class="pc-item"
                :class="{ active: this.$route.path === '/sample-page' }"
              >
                <router-link to="/sample-page" class="pc-link">
                  <span class="pc-micon">
        ...
        <BCol sm="12">
          <BCard no-body>
            <BCardBody>
              <h5>Brand Color</h5>
              <small
                >set background utility class in <code>.m-header</code> in sidebar</small
              >
              <BRow class="g-3 mt-3">
                <div class="col-auto">
                  <a
                    href="#"
                    class="avtar avtar-s bg-brand-color-1"
                    @click="changebrand('bg-brand-color-1')"
                  >
                ...
                <div class="col-auto">
                  <a
                    href="#"
                    class="avtar avtar-s bg-brand-color-2"
                    @click="changebrand('bg-brand-color-2')"
                  >
                    <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                  </a>
                </div>
                <div class="col-auto">
                  <a
                    href="#"
                    class="avtar avtar-s bg-brand-color-3"
                    @click="changebrand('bg-brand-color-3')"
                  >
                    <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                  </a>
                </div>
                <div class="col-auto">
                  <a
                    href="#"
                    class="avtar avtar-s bg-primary"
                    @click="changebrand('bg-primary')"
                  >
                    <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                  </a>
                </div>
                <div class="col-auto">
                  <a
                    href="#"
                    class="avtar avtar-s bg-secondary"
                    @click="changebrand('bg-secondary')"
                  >
                    <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                  </a>
                </div>
                <div class="col-auto">
                  <a
                    href="#"
                    class="avtar avtar-s bg-danger"
                    @click="changebrand('bg-danger')"
                  >
                    <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                  </a>
                </div>
                <div class="col-auto">
                  <a
                    href="#"
                    class="avtar avtar-s bg-success"
                    @click="changebrand('bg-success')"
                  >
                    <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                  </a>
                </div>
                <div class="col-auto">
                  <a
                    href="#"
                    class="avtar avtar-s bg-warning"
                    @click="changebrand('bg-warning')"
                  >
                    <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                  </a>
                </div>
                <div class="col-auto">
                  <a
                    href="#"
                    class="avtar avtar-s bg-info"
                    @click="changebrand('bg-info')"
                  >
                    <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                  </a>
                </div>
