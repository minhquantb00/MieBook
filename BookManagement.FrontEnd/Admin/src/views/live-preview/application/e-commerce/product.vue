...
<template>
  <Layout>
    <pageheader title="Product" pageTitle="E-commerce" />
    <BRow>
      <div class="col-sm-12">
                        ...
                        <simplebar data-simplebar style="height: 620px">
                          <div class="card-body">
                            <ul class="list-group list-group-flush">
                                  ...
                                  <div>
                                    <div class="form-check mb-2">
                                      <input
                                        ...
                                        id="chkratt1"
                                      />
                                      <label class="form-check-label" for="chkratt1"
                                        >4★ &amp; above</label
                                      >
                                    </div>
                                    <div class="form-check mb-2">
                                      <input
                                        ...
                                        id="chkratt2"
                                      />
                                      <label class="form-check-label" for="chkratt2"
                                        >3★ &amp; above</label
                                      >
                                    </div>
                                    <div class="form-check mb-2">
                                      <input
                                        ...
                                        id="chkratt3"
                                      />
                                      <label class="form-check-label" for="chkratt3"
                                        >2★ &amp; above</label
                                      >
                                    </div>
                                    <div class="form-check mb-2">
                                      <input
                                        ...
                                        id="chkratt4"
                                      />
                                      <label class="form-check-label" for="chkratt4"
                                        >1★ &amp; above</label
                                      >
                                    </div>
                                  </div>
                              ...
                              <li class="list-group-item border-0 px-0 py-2">
                                <a href="#" class="btn btn-light-danger w-100"
                                  >Clear All</a
                                >
                              </li>
                            </ul>
              ...
              <BCol class="col-sm-6 col-xl-4">
                <Bcard class="product-card">
                  <div class="card-img-top">
                    <router-link to="/product-details">
                      <img
                        src="@/assets/images/application/img-prod-9.jpg"
                        alt="image"
                        class="img-prod img-fluid"
                      />
                    </router-link>
