...
<template>
  <Layout>
    <pageheader title="Team" pageTitle="Ui kit" />
    <BRow>
            ...
            <table class="table tbl-product" id="pc-dt-simple">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <BRow class="row">
                      ...
                      <BCol class="col">
                        ...
                        <a
                          class="text-muted f-12 text-hover-primary"
                          href="mailto:demo@mail.com"
                          >Carson_Darrin@domain.com</a
                        >
                      </BCol>
                    </BRow>
                  </td>
                  <td>
                    <a class="text-muted text-hover-primary" href="#">SR.Pvt.Ltd</a>
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="user-group">
                      ...
                      />
                      <span class="avtar rounded-circle bg-light-primary text-primary"
                        >+1</span
                      >
                    </div>
                  </td>
                    ...
                    <BRow class="row">
                      ...
                      <BCol class="col">
                        ...
                        <a
                          class="text-muted f-12 text-hover-primary"
                          href="mailto:demo@mail.com"
                          >John_Doe@domain.com</a
                        >
                      </BCol>
                    </BRow>
                  </td>
                  <td>
                    <a class="text-muted text-hover-primary" href="#">SMT.Pvt.Ltd</a>
                  </td>
                  <td>
                    <BRow class="row align-items-center">
                      <BCol class="col-auto pe-5">
                    ...
                    <BRow class="row">
                      ...
                      <BCol class="col">
                        ...
                        <a
                          class="text-muted f-12 text-hover-primary"
                          href="mailto:demo@mail.com"
                          >Adeline@domain.com</a
                        >
                      </BCol>
                    </BRow>
                  </td>
                  <td>
                    <a class="text-muted text-hover-primary" href="#">JCBK.Pvt.Ltd</a>
                  </td>
                  <td>
                    <BRow class="row align-items-center">
                      <BCol class="col-auto pe-5">
                ...
                <tr>
                  ...
                  <td>
                    <a class="text-muted text-hover-primary" href="#">DDMS.Pvt.Ltd</a>
                  </td>
                  <td>
                    <BRow class="row align-items-center">
                      <BCol class="col-auto pe-5">
