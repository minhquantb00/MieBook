...
<template>
  <Layout>
    ...
    <BRow>
          ...
          <BCardBody>
            ...
            <div class="d-flex align-items-center">
              <h3 class="f-w-300 d-flex align-items-center m-b-0">
                237 <small class="text-muted">/400</small>
              </h3>
      ...
      <BCol sm="6" xl="4">
        <BCard class="statistics-card-1" no-body>
          ...
          <BCardBody>
            ...
            <div class="d-flex align-items-center">
              <h3 class="f-w-300 d-flex align-items-center m-b-0">
                100 <small class="text-muted">/500</small>
              </h3>
      ...
      <BCol sm="6" xl="4">
        <BCard class="statistics-card-1" no-body style="">
          ...
          <BCardBody>
            ...
            <div class="d-flex align-items-center">
              <h3 class="f-w-300 d-flex align-items-center m-b-0">
                50 <small class="text-muted">/400</small>
              </h3>
        ...
        <BCard no-body class="overflow-hidden">
          <BCardBody class="bg-light-primary">
            <BRow class="align-items-center">
              ...
              <BCol cols="6">
                <img
                  src="@/assets/images/widget/img-visitor.png"
                  alt="img"
                  class="img-fluid"
                />
              </BCol>
        ...
        <BCard no-body>
          <BCardBody>
            <div class="d-flex align-items-center justify-content-between">
              <p class="mb-0">
                <i class="ph-duotone ph-circle text-warning me-2"></i> Parcel in the way
              </p>
              <i
                class="ph-duotone ph-info f-20 ms-1"
                data-bs-toggle="tooltip"
                data-bs-title="Parcel in the way"
              ></i>
            </div>
            <div class="d-flex align-items-center my-2">
              <h2 class="d-flex align-items-center m-b-0">
                25 <small class="text-muted">/40</small>
              </h2>
            </div>
            <p class="mb-0">
              <span class="text-success"
                ><i class="ph-duotone ph-caret-up f-20 align-bottom"></i> +15%</span
              >
              last month
            </p>
          </BCardBody>
      ...
      <BCol md="12" xl="8">
        <BCard no-body class="bg-brand-color-1 earning-card statistics-card-1">
          <BCardHeader class="d-flex align-items-center justify-content-between py-2">
            ...
            >
              <template #button-content
                ><span class="text-muted"
                  ><i class="material-icons-two-tone bg-white f-18">more_vert</i></span
                >
              </template>
              <BDropdownItem>View</BDropdownItem>
              <BDropdownItem>Edit</BDropdownItem>
          ...
          <BCardBody class="overflow-hidden">
            <img
              src="@/assets/images/widget/img-earning-bg.svg"
              alt="img"
              class="img-fluid img-bg h-100"
            />
            <ul
              class="nav nav-fill nav-pills align-items-center justify-content-center mb-5"
              id="pills-tab"
              role="tablist"
            >
              <li class="nav-item">
              ...
              <div class="media-body me-2">
                <div class="user-group">
                  ...
                  <img
                    ...
                    class="avtar"
                  />
                  <span class="avtar rounded-circle bg-light-warning text-warning"
                    >+2</span
                  >
                </div>
              </div>
              <a href="#" class="avtar avtar-s bg-primary rounded-circle text-white"
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <BRow class="g-1">
              <BCol cols="6">
                <p class="mb-0">
                  <i class="ph-duotone ph-circle text-success f-12"></i> React native
                </p>
              </BCol>
              <BCol cols="6">
                <p class="mb-0">
                  <i class="ph-duotone ph-circle text-primary f-12"></i> Figma
                </p>
              </BCol>
              <BCol cols="6">
                <p class="mb-0">
                  <i class="ph-duotone ph-circle text-warning f-12"></i> Bootstrap 5
                </p>
              </BCol>
              <BCol cols="6">
                <p class="mb-0">
                  <i class="ph-duotone ph-circle text-danger f-12"></i> Shopify
                </p>
              </BCol>
            </BRow>
          </BCardBody>
        ...
        <BCard no-body>
          <BCardBody>
            <div class="d-flex align-items-center justify-content-between mb-2">
              ...
              <i
                class="ph-duotone ph-arrow-square-in f-20 ms-1 text-danger"
                data-bs-toggle="tooltip"
                data-bs-title="Income this month"
              ></i>
            </div>
            <div class="d-flex align-items-center">
              <h5 class="mb-0">$3,569</h5>
              <span class="badge bg-danger ms-2"
                ><i class="ph-duotone ph-arrow-down me-1 align-middle"></i> 2.6%</span
              >
            </div>
          </BCardBody>
        </BCard>
