                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <BLink class="pc-link" v-b-toggle.collapse-47>
                            <span class="pc-micon">
                                <i class="ph-duotone ph-gauge"></i></span><span class="pc-mtext"><span class="pc-badge">2</span><router-link class="pc-link" to="/home">Trang chủ</router-link></span><span class="pc-arrow">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <BLink class="pc-link" v-b-toggle.collapse-27>
                            <span class="pc-micon">
                                <i class="ph-duotone ph-layout"></i></span><span class="pc-mtext">Sách mới</span><span class="pc-arrow">
                                <ChevronDownIcon></ChevronDownIcon>
                            </span>
                        </BLink>
                    </li>
                    ...
                    <li class="pc-item" :class="{ 'active': this.$route.path === '/user' }">
                        <router-link to="/user" class="pc-link">
                            ...
                            <span class="pc-mtext"> Chủ đề</span>
                        </router-link>
                    </li>
                    <li class="pc-item" :class="{ 'active': this.$route.path === '/data' }">
                        <router-link to="/data" class="pc-link">
                            ...
                            <span class="pc-mtext"> Danh mục</span>
                        </router-link>
                    </li>
