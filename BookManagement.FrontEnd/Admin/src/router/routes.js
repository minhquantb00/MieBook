export default [
  ...
  },
  {
    ...
    component: () =>
      import("../views/live-preview/ui-kit/affiliate-dashboard.vue"),
  },
  {
    path: "/gallery-1",
    name: "gallery-1",
  ...
  },
  {
    ...
    component: () =>
      import("../views/live-preview/form/element/input-group.vue"),
  },
  {
    path: "/checkbox",
    name: "checkbox",
  ...
  },
  {
    ...
    component: () =>
      import("../views/live-preview/form/element/mega-option.vue"),
  },
  {
    path: "/layouts",
    name: "layouts",
  ...
  },
  {
    ...
    component: () =>
      import("../views/live-preview/form/layout/multicolumn.vue"),
  },
  {
    path: "/actionbars",
    name: "actionbars",
  ...
  },
  {
    ...
    component: () =>
      import("../views/live-preview/form/layout/sticky-action.vue"),
  },
  {
    path: "/dropzone",
    name: "dropzone",
  ...
  },
  {
    ...
    component: () =>
      import("../views/live-preview/table/bootstrap/styling.vue"),
  },
  {
    path: "/basic",
    name: "basic",
  ...
  // Charts & maps
  {
    ...
    component: () =>
      import("../views/live-preview/charts&map/apexchart/apexchart.vue"),
  },
  {
    path: "/maps",
    name: "maps",
  ...
  // Apllication
  {
    ...
    meta: { title: "Calendar" },
    component: () =>
      import("../views/live-preview/application/calendar/index.vue"),
  },
  {
    path: "/chat",
    name: "chat",
  ...
  },
  {
    ...
    meta: { title: "gallery" },
    component: () =>
      import("../views/live-preview/application/gallery-grid.vue"),
  },
  {
    ...
    component: () =>
      import("../views/live-preview/application/gallery-masonry.vue"),
  },
  ...
  // E-commerce
  {
    ...
    meta: { title: "Product" },
    component: () =>
      import("../views/live-preview/application/e-commerce/product.vue"),
  },
  {
    path: "/add-product",
    name: "add-product",
    ...
    component: () =>
      import("../views/live-preview/application/e-commerce/add-product.vue"),
  },
  {
    path: "/add-category",
    name: "add-category",
  ...
  },
  {
    ...
    component: () =>
      import("../views/live-preview/application/e-commerce/update-product.vue"),
  },
  {
    ...
    component: () =>
      import("../views/live-preview/application/category/update-category.vue"),
  },
  {
    ...
    component: () =>
      import(
        "../views/live-preview/application/e-commerce/product-details.vue"
      ),
  },
  {
    path: "/product-list",
    ...
    component: () =>
      import("../views/live-preview/application/e-commerce/product-list.vue"),
  },
  {
    path: "/category-list",
    name: "category-list",
    ...
    component: () =>
      import("../views/live-preview/application/category/category-list.vue"),
  },
  {
    path: "/checkout",
    name: "checkout",
    meta: { title: "Checkout" },
    component: () =>
      import("../views/live-preview/application/e-commerce/checkout.vue"),
  },
  {
    path: "/mail",
    name: "mail",
  ...
  // Users
  {
    ...
    component: () =>
      import("../views/live-preview/application/users/account-profile.vue"),
  },
  {
    path: "/social-media",
    name: "social-media",
    ...
    component: () =>
      import("../views/live-preview/application/users/social-media.vue"),
  },
  {
    path: "/user-card",
    name: "user-card",
    ...
    component: () =>
      import("../views/live-preview/application/users/user-card.vue"),
  },
  {
    path: "/user-list",
    name: "user-list",
    ...
    component: () =>
      import("../views/live-preview/application/users/user-list.vue"),
  },
  ...
  // Invoice
  {
    ...
    component: () =>
      import("../views/live-preview/application/invoice/invoice-list.vue"),
  },
  {
    path: "/create",
    name: "create",
    meta: { title: "Create" },
    component: () =>
      import("../views/live-preview/application/invoice/create.vue"),
  },
  {
    path: "/preview",
    name: "preview",
  ...
  },
  {
    ...
    component: () =>
      import("../views/live-preview/pages/auth1/reset-password.vue"),
  },
  {
    ...
    component: () =>
      import("../views/live-preview/pages/auth1/code-verification.vue"),
  },
  ...
  },
  {
    ...
    component: () =>
      import("../views/live-preview/pages/maintenance/connection-lost.vue"),
  },
  {
    ...
    component: () =>
      import("../views/live-preview/pages/maintenance/under-construction.vue"),
  },
  {
    path: "/comming-soon",
    name: "comming-soon",
